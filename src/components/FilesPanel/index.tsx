  ...
  return {
    ...
    displayStates: [
      ...
      { id: 'ds-hover', name: 'Pressed', layerOverrides: [
        { layerId: 'el-btn', properties: { fill: '#1d4ed8', scale: 0.95 }, isKey: true },
  ...
  return {
    ...
    displayStates: [
      ...
      { id: 'ds-expanded', name: 'Expanded', layerOverrides: [
        { layerId: 'el-card', properties: { width: 350, height: 200 }, isKey: true },
        { layerId: 'el-expand-body', properties: { opacity: 1 }, isKey: true },
        { layerId: 'el-expand-hint', properties: { opacity: 0 }, isKey: true },
        { layerId: 'el-card2', properties: { x: 20, y: 380 }, isKey: true },
        { layerId: 'el-avatar2', properties: { x: 36, y: 396 }, isKey: true },
        { layerId: 'el-avatar2-text', properties: { x: 48, y: 406 }, isKey: true },
        { layerId: 'el-title2', properties: { x: 96, y: 398 }, isKey: true },
        { layerId: 'el-desc2', properties: { x: 96, y: 420 }, isKey: true },
      ]},
    ],
    patches: [
      {
  ...
  return {
    ...
    displayStates: [
      ...
      { id: 'ds-tab2', name: 'Tab 2', layerOverrides: [
        ...
        { layerId: 'el-indicator', properties: { x: 145, y: 822 }, isKey: true },
      ]},
  ...
  return {
    ...
    displayStates: [
      ...
      { id: 'ds-on', name: 'On', layerOverrides: [
        ...
        { layerId: 'el-thumb', properties: { x: 323, y: 185 }, isKey: true },
      ]},
    ],
    patches: [
      {
  ...
  return {
    ...
    displayStates: [
      ...
      { id: 'ds-dismissed', name: 'Dismissed', layerOverrides: [
        { layerId: 'el-card', properties: { x: 400, y: 170, opacity: 0 }, isKey: true },
        ...
        { layerId: 'el-card2', properties: { x: 20, y: 170 }, isKey: true },
        { layerId: 'el-icon2', properties: { x: 36, y: 186 }, isKey: true },
        { layerId: 'el-icon2-text', properties: { x: 48, y: 194 }, isKey: true },
        { layerId: 'el-title2', properties: { x: 92, y: 188 }, isKey: true },
        { layerId: 'el-desc2', properties: { x: 92, y: 210 }, isKey: true },
        { layerId: 'el-card3', properties: { x: 20, y: 270 }, isKey: true },
        { layerId: 'el-icon3', properties: { x: 36, y: 286 }, isKey: true },
        { layerId: 'el-icon3-text', properties: { x: 48, y: 294 }, isKey: true },
        { layerId: 'el-title3', properties: { x: 92, y: 288 }, isKey: true },
        { layerId: 'el-desc3', properties: { x: 92, y: 310 }, isKey: true },
      ]},
    ],
    patches: [
      {
